...
if (@$_GET['q'] == "addTopic")
{
    ?>
    <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
        <h2 style="font-weight: 300;" align="center">Add Topic</h2>

        <div style="height:130px; overflow:scroll;">
            <form action="process.php?action=addTopic" method="post" >
                <div class="full_width">
...
if(@$_GET['q'] == "editTopic")
{
    ...
    <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
        <h2 style="font-weight: 300;" align="center">Edit Topic</h2>

        <div style="height:100%; overflow:scroll;">
            <form action="process.php?action=editTopic" method="post" >
                <input name="id" type="hidden" value="<?php echo $id; ?>" required>
                <div class="full_width">
                    <label class="field_title">Name</label>
                    <input name="title" type="text" value="<?php echo $json_data['msg']['Topic']['title']; ?>" required>
                </div>
        ...
        <div class="main-container dataTables_wrapper" id="table_view_wrapper" style="height: 500px;overflow: scroll;" >
            ...
            <div>
                ...
                <div id="profileInfo" class="tab" style="display:none">
                    ...
                    <div style="border-bottom:solid 1px #e6e6e6; padding: 10px 0 10px 10px;">
                        <div style="float:left; width:150px;font-size: 14px;">Wallet</div>
                        <div style="float:left; width:150px;">
                            <?php echo $json_data['User']['wallet']; ?>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div style="border-bottom:solid 1px #e6e6e6; padding: 10px 0 10px 10px;">
        ...
        <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
            ...
            <div style="height:auto; overflow:scroll;">
                ...
                <form action="process.php?action=addGifts" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="hasGif" class="hasGif" value="0">
                    <div class="full_width">
                        <label class="field_title">Name</label>
                        <input name="title" type="text" required="">
                    </div>
                    ...
                    <div class="full_width">
                        ...
                        <input name="giftImage" id='giftImage' type="file" required="" accept=".jpg,.png,.jpeg,.gif" style="padding: 12px 0 0 0;">
                    </div>
                    
                    <div class="gifPart" style="display:none;">
                        <div class="full_width">
                            <label class="field_title">Time (Set the desired time value in seconds below to control gif duration)</label>
                            <input name="time" type="number" value="0" required>
                        </div>
                        
                        <div class="full_width">
                            <label class="field_title">Sound</label>
                            <input name="sound" id='sound' type="file" accept=".mp3" style="padding: 12px 0 0 0;">
                        </div>
                        
                        <div class="full_width">
                            <label class="field_title">Icon</label>
                            <input name="icon" id='icon' type="file" accept=".jpg,.png,.jpeg" style="padding: 12px 0 0 0;">
                        </div>
            ...
            <div style="height:auto; overflow:scroll;">
                ...
                <form action="process.php?action=editGift" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        $path = parse_url($json_data['msg']['Gift']['image'], PHP_URL_PATH);
                        ...
                        if($extension=="gif" || $extension=="GIF")
                        {
                            ?>
                                <div class="full_width">
                                    <label class="field_title">Time (Set the desired time value in seconds below to control gif duration)</label>
                                    <input name="time" type="number" value="<?php echo $json_data['msg']['Gift']['time']; ?>" required>
                                </div>
                            <?php
                        }
                        else
                        {
                            ?>
                                 <input name="time" type="hidden" value="0" required>
                            <?php
                        }
                    ?>
    ...
    <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
        ...
        <div style="overflow:scroll;">
            <form action="process.php?action=sendUserAccountNotificationToAllUsers" method="post" >
                ...
                <div class="full_width clear_both">
                    <label class="field_title">Description</label>
                    <textarea name="text" type="text" placeholder="Qboxus is on tictic. check their profile for latest updates" required maxlength="65"></textarea>
                </div>
            ...
            foreach ($json_data['msg'] as $singleRow): 
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $singleRow['User']['wallet']; ?>
                        </td>
                        <td>
                            <?php echo $singleRow['User']['created']; ?>
                        </td>
                        ...
                        <td>
                            <div class="more">
                                ...
                                <div class="more-menu">
                                    ...
                                    <ul class="more-menu-items" tabindex="-1" role="menu" aria-labelledby="more-btn" aria-hidden="true">
                                        <li class="more-menu-item" role="presentation" onclick="purchaseCoin('<?php echo $singleRow['User']['id']; ?>')">
                                            <button type="button" class="more-menu-btn" role="menuitem">Recharge Coins</button>
                                        </li>
                                        <li class="more-menu-item" role="presentation" onclick="postVideo('<?php echo $singleRow['User']['id']; ?>')">
                                            <button type="button" class="more-menu-btn" role="menuitem">Post Video</button>
                                        </li>
...
if (@$_GET['q'] == "addSetting")
{
    ...
    <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
        ...
        <div style="height:auto; overflow:scroll;">
            <form action="process.php?action=addSetting" method="post" >
                
                <div class="full_width">
                    <label class="field_title">Type</label>
                    <select name="selectType" class="form-control addSetting" required="">
                        <option value="">Select Type</option>
                        <option value="referral_coin">Referral Coin Reward</option>
                        <option value="add_type" >Advert Company</option>
                        <option value="coin_worth">Coins equivalent to dollar</option>
                        <option value="video_compression">Video Compression (lowering this value will decrease video quality)</option>
                   </select>
                </div>
                
                
                <div id="onChangeValue"></div>
                <div id="onChangeValue1"></div>
...
if (@$_GET['q'] == "purchaseCoin")
{
    ?>
    <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
        <h2 style="font-weight: 300;" align="center">Purchase Coin</h2>

        <div style="height:auto; overflow:scroll;">
            <form action="process.php?action=purchaseCoin" method="post" >
               <input type="hidden" name="user_id" value="<?php echo $_GET['user_id']; ?>">
                ...
                <div class="full_width">
                    <label class="field_title">Transaction ID</label>
        ...
        <div style="height:auto; overflow:scroll;">
            <form class="addCategoriesForm">
               <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                ...
                <div class="full_width">
                    <label class="field_title">Image</label>
                    <input name="image" type="file" style="padding-top: 12px;font-size: 12px;">
                </div>
...
if (@$_GET['q'] == "edit_Category")
{
    ...
    ?>
        <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
            ...
            <div style="height:auto; overflow:scroll;">
                <form class="editCategoriesForm">
                   <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <div class="full_width">
                        <label class="field_title">Title</label>
                        <input name="title" type="text" value="<?php echo $json_data['Category']['title']; ?>">
                    </div>
...
if (@$_GET['q'] == "showCategories")
{
    ...
    ?>
        <div class="categories-button-wrapper" data-parent-id="<?php echo $id; ?>">
            ...
            if($json_data['code']=="200")
            {
                ...
                {
                    ?>
                        <div class="categories-single-item showCategories" data-id="<?php echo $singleRow['Category']['id']; ?>" data-parent-id="<?php echo $id; ?>">
            ...
            <div class="addCategories" data-id="<?php echo $id; ?>" style="border: dashed 1.5px #c4c2c2;padding: 4px 10px;font-size: 13px;text-align: center;background: #f9f9f9;cursor: pointer;">
               <div class="text-label">
                   <p class="label-name">
                        Add Category
                   </p>
...
if (@$_GET['q'] == "postVideo")
{
    ...
    ?>
        <div class="main-container dataTables_wrapper" id="table_view_wrapper" >
            <h2 style="font-weight: 300;" align="center">Post Video</h2>
    
            <div style="height:auto; overflow:scroll;">
                <form action="process.php?action=postVideo" method="post" enctype="multipart/form-data">
                   <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                    
                    <div class="full_width">
                        <label class="field_title">Video</label>
                        <input name="video" type="file" style="padding-top: 12px;font-size: 12px;" accept=".mp4">
                    </div>
                    ...
                    <div class="full_width clear_both">
                        <label class="field_title">Privacy</label>
                    ...
                    <div class="full_width clear_both">
                        <label class="field_title">Duet</label>
                        <select name="duet" class="form-control" required>
                            <option value="true" selected>Allow</option>
                            <option value="false">Don't Allow</option>
                       </select>
                    </div>
