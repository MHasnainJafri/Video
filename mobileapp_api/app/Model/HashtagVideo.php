...
class HashtagVideo extends AppModel
{
    ...
    public function getHashtagVideos($hashtag_id)
    {
        ...
        return $this->find('all', array(
            'contain' => array('Video.Product','Video.Sound','Video.User.PrivacySetting','Video.User.PushNotification','Video','Hashtag'),
            'conditions' => array(
    ...
    public function getHashtagVideosWithLimit($hashtag_id,$starting_point)
    {
        $this->Behaviors->attach('Containable');
        return $this->find('all', array(
            'contain' => array('Video.Product','Video.Sound','Video.User.PrivacySetting','Video.User.PushNotification','Hashtag',
