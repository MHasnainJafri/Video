    ...
    <div class="main-container">
        <div class="header-container">
            <div class="header-logo-container">
                <a href="dashboard.php?p=products"> 
            ...
            <div class="header-search-bar-container">
                <div class="serach-bar-container">
                    ...
                    <!--    <input type="text" id="search"placeholder="Search" autocapitalize="off" autocomplete="off" autocorrect="off">-->
                    ...
                    <!--</div>-->
                    <!--<div class="mainSearch" id="mainSearch"></div>-->
                ...
                <div class="user-dropdown">
                    <button class="user-dropdown-btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <?php echo $_SESSION[PRE_FIX.'first_name'].' '.$_SESSION[PRE_FIX.'last_name'];?>
                    </button>
