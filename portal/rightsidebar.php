    ...
    <div class="qr-sidebar-title-area">
        ...
        <div class="not-mobile">
            <ul>
                ...
                <li>
                    <a href="dashboard.php?p=spacesTopics" class="<?php if (strpos($_SERVER['REQUEST_URI'], "spacesTopics") !== false) { echo "router-link-active ";} ?>"> 
                        <i aria-hidden="true" class="fas fa-gift"></i>
                        Spaces Topics
                    </a>
                </li>
                ...
                <li>
                    <a href="dashboard.php?p=category" class="<?php if (strpos($_SERVER['REQUEST_URI'], "category") !== false) { echo "router-link-active ";} ?>"> 
                        <i aria-hidden="true" class="fas fa-hand-holding-usd"></i>
                        Category
                    </a>
                </li>
